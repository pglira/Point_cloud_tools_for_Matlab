...
p.addParamValue('AttributeName'  , '' , @ischar);          % for mode 'Attribute'
p.addParamValue('AttributeMinMax', [] , @(x) numel(x)==2); % for mode 'Attribute'
...
procHierarchy = {'CORRPOI' 'REJECTION'};
msg('S', procHierarchy);
