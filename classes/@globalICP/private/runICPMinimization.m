...
adj = lsAdj;
g.adjIdx = []; % just no make sure this isn't used until its newly assigned
...
if p.NoOfTransfParam <= 7
    ...
    for i = 1:g.nPC
        ...
        adjIdx.prm_opk{i} = adj.addPrm('x0'   , zeros(3,1), ...
                                       'const', constRotPrm, ...
        ...
        adjIdx.prm_t{i} = adj.addPrm('x0'   , zeros(3,1), ...
                                     'const', constTransPrm, ...
        ...
        adjIdx.prm_m{i} = adj.addPrm('x0'   , 1, ...
                                     'const', constScalePrm, ...
    ...
    for i = 1:size(p.PairList,1)
        ...
        if size(CP{i}.X1,1) >= p.NoOfTransfParam % just add correspondences if no. of corr. >= p.NoOfTransfParam
            ...
            % Add observations
            adjIdx.obs_dp{i} = adj.addObs('b'          , zeros(size(CP{i}.X1,1),1), ...
                                          'sigb_priori', ones(size(CP{i}.X1,1),1)*sigdp_priori, ...
                                          'pFac'       , CP{i}.A.w);

            % Add conditions
            adj.addCon('fun', @conSimPoint2PlaneOLS, ...
                       'prm', struct('om1', adjIdx.prm_opk{idxPC1}(1), ...
                                     'ph1', adjIdx.prm_opk{idxPC1}(2), ...
                                     'ka1', adjIdx.prm_opk{idxPC1}(3), ...
                                     'tx1', adjIdx.prm_t{idxPC1}(1)  , ...
                                     'ty1', adjIdx.prm_t{idxPC1}(2)  , ...
                                     'tz1', adjIdx.prm_t{idxPC1}(3)  , ...
                                     'm1' , adjIdx.prm_m{idxPC1}     , ...
                                     'om2', adjIdx.prm_opk{idxPC2}(1), ...
                                     'ph2', adjIdx.prm_opk{idxPC2}(2), ...
                                     'ka2', adjIdx.prm_opk{idxPC2}(3), ...
                                     'tx2', adjIdx.prm_t{idxPC2}(1)  , ...
                                     'ty2', adjIdx.prm_t{idxPC2}(2)  , ...
                                     'tz2', adjIdx.prm_t{idxPC2}(3)  , ...
                                     'm2' , adjIdx.prm_m{idxPC2})    , ...
...
if p.NoOfTransfParam == 12
    ...
    for i = 1:g.nPC
        ...
        adjIdx.prm_a{i} = adj.addPrm('x0', [1 0 0 0 1 0 0 0 1]', ... % a11, a12, a13, a21, a22, a23, a31, a32, a33
                                     'const', constPrm, ...
    ...
    for i = 1:size(p.PairList,1)
        ...
        if size(CP{i}.X1,1) >= p.NoOfTransfParam % just add correspondences if no. of corr. >= p.NoOfTransfParam
            ...
            adj.addCon('fun', @conAffPoint2PlaneSimpleOLS, ...
                       'prm', struct('a111', adjIdx.prm_a{idxPC1}(1) , ...
                                     'a121', adjIdx.prm_a{idxPC1}(2) , ...
                                     'a131', adjIdx.prm_a{idxPC1}(3) , ...
                                     'a211', adjIdx.prm_a{idxPC1}(4) , ...
                                     'a221', adjIdx.prm_a{idxPC1}(5) , ...
                                     'a231', adjIdx.prm_a{idxPC1}(6) , ...
                                     'a311', adjIdx.prm_a{idxPC1}(7) , ...
                                     'a321', adjIdx.prm_a{idxPC1}(8) , ...
                                     'a331', adjIdx.prm_a{idxPC1}(9) , ...
                                     'a112', adjIdx.prm_a{idxPC2}(1) , ...
                                     'a122', adjIdx.prm_a{idxPC2}(2) , ...
                                     'a132', adjIdx.prm_a{idxPC2}(3) , ...
                                     'a212', adjIdx.prm_a{idxPC2}(4) , ...
                                     'a222', adjIdx.prm_a{idxPC2}(5) , ...
                                     'a232', adjIdx.prm_a{idxPC2}(6) , ...
                                     'a312', adjIdx.prm_a{idxPC2}(7) , ...
                                     'a322', adjIdx.prm_a{idxPC2}(8) , ...
                                     'a332', adjIdx.prm_a{idxPC2}(9) , ...
                                     'tx1' , adjIdx.prm_t{idxPC1}(1) , ...
                                     'ty1' , adjIdx.prm_t{idxPC1}(2) , ...
                                     'tz1' , adjIdx.prm_t{idxPC1}(3) , ...
                                     'tx2' , adjIdx.prm_t{idxPC2}(1) , ...
